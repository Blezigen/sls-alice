...
namespace console\modules\generator\generators\migrations;
...
class Generator extends \yii\gii\Generator
{
    ...
    public $databaseNs = 'console\\migrations';
    ...
    public function generate()
    {
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            $params = [
                ...
                'metaTableName' => "_meta_{$tableName}_field_values",
                'filePrefix' => $filePrefix,
            ];

            $filename = $params['filePrefix'] . '_' . $params['metaTableName'];

            $migrationPath = Yii::getAlias('@' . str_replace('\\', '/', $this->databaseNs)) . '/' . $filename . '.php';
            $files[] = new CodeFile($migrationPath, $this->render('migration.php', $params));
        }
